!(function (e, t) {
  ...
  (() => {
    ...
    class p {
      constructor(e, t, n, i) {
        (this.element = e),
          ...
          (this.identifier = n.identifier || f("missing identifier")),
          (this.methodName = n.methodName || f("missing method name")),
          ...
          (function (e) {
            ...
            return (
                ...
                ((n += `.${i}`), (i = "")),
              {
                eventTarget:
                  ((s = t[4]),
                  "window" == s ? window : "document" == s ? document : void 0),
                eventName: n,
                eventOptions: t[7]
                  ? ((o = t[7]),
                    o
      ...
      shouldIgnoreKeyboardEvent(e) {
        ...
        return (
          ...
          (d(this.keyMappings, n) ||
            f(`contains unknown key filter: ${this.keyFilter}`),
    ...
    class v {
      ...
      applyEventModifiers(e) {
        ...
        for (const [r, o] of Object.entries(this.eventOptions))
          if (r in n) {
            ...
            s =
              s &&
              a({ name: r, value: o, event: e, element: t, controller: i });
          }
        return s;
      }
      ...
      invokeWithEvent(e) {
        ...
        try {
          ...
          const { identifier: n, controller: i, element: s, index: r } = this,
            o = {
              identifier: n,
              controller: i,
              element: s,
    ...
    class x {
      constructor(e, t, n) {
        (this.tokenListObserver = new T(e, t, this)),
          (this.delegate = n),
    ...
    class S {
      ...
      setupSelectorObserverForOutlet(e) {
        const t = this.selector(e),
          n = new O(document.body, t, this, { outletName: e });
      ...
      get outletDependencies() {
        ...
        return (
          this.router.modules.forEach((t) => {
            L(t.definition.controllerConstructor, "outlets").forEach((n) =>
    ...
    class D {
      constructor(e, t) {
        (this.logDebugActivity = (e, t = {}) => {
          const { identifier: n, controller: i, element: s } = this;
          (t = Object.assign({ identifier: n, controller: i, element: s }, t)),
          ...
          (this.targetObserver = new M(this, this)),
          (this.outletObserver = new S(this, this));
        try {
      ...
      handleError(e, t, n = {}) {
        const { identifier: i, controller: s, element: r } = this;
        (n = Object.assign({ identifier: i, controller: s, element: r }, n)),
          this.application.handleError(e, `Error ${t}`, n);
      }
      targetConnected(e, t) {
                  ...
                  const n = B(e),
                    i = (function (e, t) {
                      return N(t).reduce((n, i) => {
                        ...
                        return s && Object.assign(n, { [i]: s }), n;
                      }, {});
                    })(e.prototype, t);
      ...
      deprecate(e, t) {
        if (e) {
          ...
          this.guide.warn(
            e,
            `target:${t}`,
            `Please replace ${i}="${n}.${t}" with ${s}="${t}". The ${i} attribute is deprecated and will be removed in a future version of Stimulus.`
          );
        }
        return e;
      }
    ...
    class H {
      constructor(e, t, n, i) {
        (this.targets = new K(this)),
          ...
          (this.identifier = n),
          (this.guide = new P(i)),
          (this.outlets = new _(this.documentScope, t));
      }
      findElement(e) {
    ...
    class U {
      constructor(e) {
        (this.application = e),
          (this.scopeObserver = new R(this.element, this.schema, this)),
        ...
        return t.reduce(
          (e, t) =>
            Object.assign(
              ...
              (function (e, t) {
                const n = Y(e, void 0),
                  { key: i, name: s, reader: r, writer: o } = n;
                return {
                  [s]: {
                    get() {
                      const e = this.data.get(i);
                      return null !== e ? r(e) : n.defaultValue;
                    },
                    set(e) {
                      void 0 === e
                        ? this.data.delete(i)
    ...
    class oe extends ie {
      ...
      triggerEvent(e, t, n) {
        ...
        let s;
        try {
          s = new CustomEvent(i, { bubbles: !0, cancelable: !0, detail: t });
        } catch (e) {
          (s = document.createEvent("CustomEvent")),
            s.initCustomEvent(i, !0, !0, t);
        }
    ...
    function ae(e) {
      var t, n;
      const i = e.hasOwnProperty("targets")
        ? (((n = class extends oe {}).targets =
            null !== (t = e.targets) && void 0 !== t ? t : []),
          n)
        : class extends oe {};
      for (const t in e) {
    ...
    class ce extends oe {
      ...
      _toggle(e, t = null) {
        ...
        this.triggerEvent(
          ...
          (this.bannerTarget.setAttribute("aria-hidden", n ? "false" : "true"),
          n || this.removeBannerOnHide(),
          this.triggerEvent(
            n ? "shown" : "hidden",
            { dispatcher: s },
            this.bannerTarget
    ...
    function ge(e) {
      e
        ? (fe++, 1 === fe && document.body.addEventListener("change", me))
        : (fe--, 0 === fe && document.body.removeEventListener("change", me));
    }
    class ve extends oe {
      constructor() {
      ...
      _isCollapsedForClickable() {
        ...
        return e.length > 0
          ? !e.every((e) => e.classList.contains("is-expanded"))
      ...
      listener(e) {
        ...
        if (this.isCheckable) t = !this.element.checked;
          ...
          if (
            ...
            return;
          if ((e.preventDefault(), "keydown" == e.type))
        ...
        for (const e of this.controlledExpandables)
    ...
    class be extends oe {
      ...
      _toggle(e, t = null) {
        ...
        r.defaultPrevented ||
          ...
          this.modalTarget.setAttribute("aria-hidden", n ? "false" : "true"),
          n
            ? (this.bindDocumentEvents(), this.focusInsideModal())
            : (this.unbindDocumentEvents(),
              this.focusReturnElement(),
              this.removeModalOnHide()),
          void 0 !== this.modalTarget.ontransitionend
      ...
      getAllTabbables() {
        ...
        ).filter((e) => e.matches(":not([disabled]):not([tabindex='-1'])"));
      }
      firstVisible(e) {
      ...
      focusInsideModal() {
        this.modalTarget.addEventListener(
          ...
          () => {
            var e;
            const t =
              null !== (e = this.firstVisible(this.initialFocusTargets)) &&
              void 0 !== e
                ? e
                : this.firstVisible(this.getAllTabbables());
            this.modalTarget.contains(document.activeElement) ||
              null == t ||
              t.focus();
          },
          { once: !0 }
        ...
        if (this.modalTarget.contains(e.target)) {
          if ("Tab" === e.key) {
            const t = this.getAllTabbables(),
              n = this.firstVisible(t),
              i = this.lastVisible(t);
            n &&
              i &&
              (n === i
                ? (e.preventDefault(), n.focus())
                : e.shiftKey && e.target === n
          ...
          const t = this.firstVisible(this.getAllTabbables());
      ...
      hideOnOutsideClick(e) {
        var t;
        const n = e.target;
        !(null === (t = this.modalTarget.querySelector(".s-modal--dialog")) ||
        void 0 === t
          ? void 0
          : t.contains(n)) &&
    ...
    class Oe extends oe {
      connect() {
        ...
        for (const e of this.tabTargets)
      ...
      handleKeydown(e) {
        ...
        s < 0 && (s = i.length - 1),
          ...
          (n = i[s]),
          this.switchToTab(n),
          null === (t = this.selectedTab) || void 0 === t || t.focus();
      }
      switchToTab(e) {
        const t = this.selectedTab;
        t !== e &&
          (this.triggerEvent("select", { oldTab: t, newTab: e })
            .defaultPrevented ||
            ((this.selectedTab = e),
            this.triggerEvent("selected", { oldTab: t, newTab: e })));
      }
      get selectedTab() {
        return (
    ...
    function De(e, t, n) {
      ...
      t &&
        xe(e) &&
        ((s = (e.offsetWidth > 0 && Le(i.width) / e.offsetWidth) || 1),
        (r = (e.offsetHeight > 0 && Le(i.height) / e.offsetHeight) || 1));
    ...
    function Ie(e) {
      return ((Te(e) ? e.ownerDocument : e.document) || window.document)
        .documentElement;
    }
    function $e(e) {
          ...
          (("body" !== Be(t) || Pe(a)) &&
            (c =
              (i = t) !== Ae(i) && xe(i)
                ...
                : Ne(i)),
          xe(t)
            ? (((h = De(t, !0)).x += t.clientLeft), (h.y += t.clientTop))
            : a && (h.x = $e(a))),
        {
    ...
    function _e(e) {
      return "html" === Be(e)
        ? e
        : e.assignedSlot || e.parentNode || (ke(e) ? e.host : null) || Ie(e);
    }
    function He(e) {
    ...
    function qe(e) {
      for (
        var t = Ae(e), n = We(e);
        n && Ue(n) && "static" === je(n).position;

      )
        n = We(n);
      return n &&
        ("html" === Be(n) || ("body" === Be(n) && "static" === je(n).position))
        ? t
        : n ||
            (function (e) {
              var t = /firefox/i.test(Fe());
              if (/Trident/i.test(Fe()) && xe(e) && "fixed" === je(e).position)
                return null;
              var n = _e(e);
              for (
                ke(n) && (n = n.host);
                xe(n) && ["html", "body"].indexOf(Be(n)) < 0;
    ...
    function ft(e) {
      ...
      if (c) {
        var O = qe(n),
          ...
          T = "clientWidth";
        O === Ae(n) &&
          "static" !== je((O = Ie(n))).position &&
          "absolute" === a &&
          ((A = "scrollHeight"), (T = "scrollWidth")),
          (s === ze || ((s === Ye || s === Xe) && r === et)) &&
            ((E = Je),
            (f -=
              (d && O === w && w.visualViewport
      ...
      var x,
        k = Object.assign({ position: a }, c && mt),
        C =
          !0 === h
            ? (function (e, t) {
                var n = e.x,
                ...
                return { x: Le(n * s) / s || 0, y: Le(i * s) / s || 0 };
              })({ x: p, y: f }, Ae(n))
            : { x: p, y: f };
      return (
        (p = C.x),
      ...
      return t === tt
        ? wt(
            (function (e, t) {
              ...
              return { width: r, height: o, x: a + $e(e), y: l };
            })(e, n)
          )
        : Te(t)
        ? (function (e, t) {
        ...
        : wt(
            (function (e) {
              var t,
                ...
                l = -i.scrollTop;
              return (
                "rtl" === je(s || n).direction &&
                  (a += Ce(n.clientWidth, s ? s.clientWidth : 0) - r),
        ...
        w = (function (e, t, n, i) {
          var s =
            ...
            a = r.reduce(function (t, n) {
              var s = Ot(e, n, i);
              return (
                (t.top = Ce(s.top, t.top)),
                (t.right = Me(s.right, t.right)),
                (t.bottom = Me(s.bottom, t.bottom)),
                (t.left = Ce(s.left, t.left)),
                t
              );
            }, Ot(e, o, i));
          return (
                ...
                return (
                  ...
                  a.orderedModifiers.forEach(function (e) {
                    var t = e.name,
                      ...
                      s = e.effect;
                    if ("function" == typeof s) {
                      var r = s({ state: a, name: t, instance: h, options: i });
                      l.push(r || function () {});
                    }
                  }),
                  h.update()
                  ...
                  if (lt(t, n)) {
                    ...
                    for (var i = 0; i < a.orderedModifiers.length; i++)
                      if (!0 !== a.reset) {
                        ...
                        "function" == typeof r &&
                          (a =
                            r({ state: a, options: l, name: d, instance: h }) ||
                            a);
                      } else (a.reset = !1), (i = -1);
                  }
                }
              ...
              if (O) {
                if (r) {
                  var L,
                    ...
                    U = kt(0, A[D], K[D]),
                    W = y
                      ? A[D] / 2 - $ - U - H - k.mainAxis
                      : j - U - H - k.mainAxis,
                    q = y
                      ? -A[D] / 2 + $ + U + R + k.mainAxis
                      : P + U + R + k.mainAxis,
    ...
    class St extends oe {
      ...
      connect() {
        super.connect(),
          ...
          this.isVisible
            ...
            : "true" === this.data.get("auto-show") && this.show(null),
      ...
      hide(e = null) {
        ...
        this.triggerEvent("hide", { dispatcher: t }).defaultPrevented ||
          ...
          this.popper && (this.popper.destroy(), delete this.popper),
          "after-dismissal" === this.data.get("hide-on-outside-click") &&
      ...
      initializePopper() {
        this.popper = Ft(this.referenceElement, this.popoverElement, {
          ...
          modifiers: [
            ...
            { name: "arrow", options: { element: ".s-popover--arrow" } },
          ],
        });
      }
      validate() {
        ...
        const t = this.referenceElement.getAttribute(
    ...
    class Dt extends St {
      ...
      shown(e = null) {
        this.toggleOptionalClasses(!0),
          this.toggleAccessibilityAttributes(!0),
          super.shown(e);
      }
      hidden(e = null) {
        this.toggleOptionalClasses(!1),
          this.toggleAccessibilityAttributes(!1),
          super.hidden(e);
      }
      connect() {
      ...
      toggleAccessibilityAttributes(e) {
        const t =
          ...
          this.referenceElement.ariaExpanded ||
          "false";
        (this.referenceElement.ariaExpanded = t),
          this.referenceElement.setAttribute("aria-expanded", t);
      }
    }
    function Nt(e) {
      const { isPopover: t, controller: n } = jt(e);
      if (n) n.show();
      else {
    ...
    function Bt(e) {
      const { isPopover: t, controller: n, popover: i } = jt(e);
      if (n) n.hide();
      else {
        if (!t) throw 'element does not have data-controller="s-popover"';
        e.removeAttribute("data-s-popover-auto-show"),
          i && i.classList.remove("is-visible");
      }
    }
    function It(e, t, n) {
      const { referenceElement: i, popover: s } = jt(e);
      ...
      if (!t.classList.contains("s-popover"))
        throw `popover should have the "s-popover" class but had class="${t.className}"`;
      if (r && r !== o)
        throw `element has aria-controls="${r}" but popover has id="${o}"`;
      o ||
        ((o =
          "--stacks-s-popover-" + Math.random().toString(36).substring(2, 10)),
        (t.id = o)),
        r || i.setAttribute("aria-controls", o),
        !t.parentElement &&
          e.parentElement &&
        ...
        n &&
          (n.toggleOnClick &&
            i.setAttribute("data-action", "click->s-popover#toggle"),
          n.placement &&
            e.setAttribute("data-s-popover-placement", n.placement),
          n.autoShow && e.setAttribute("data-s-popover-auto-show", "true"));
    }
    function $t(e) {
      const {
        isPopover: t,
      ...
      return (
        null == n || n.hide(),
        null == s || s.remove(),
        t && (Pt(e, "s-popover", !1), i && i.removeAttribute("aria-controls")),
        s
      );
    }
    function jt(e) {
      var t;
      const n =
          (null === (t = e.getAttribute("data-controller")) || void 0 === t
            ? void 0
            : t.includes("s-popover")) || !1,
    ...
    function Pt(e, t, n) {
      var i;
      const s = new Set(
        null === (i = e.getAttribute("data-controller")) || void 0 === i
          ? void 0
          : i.split(/\s+/)
      );
      n ? s.add(t) : s.delete(t),
        e.setAttribute("data-controller", Array.from(s).join(" "));
    }
    (Dt.targets = []),
      (function (e) {
    ...
    class Vt extends oe {
      constructor() {
        super(...arguments),
          (this.updateSortedColumnStyles = (e, t) => {
            this.columnTargets.forEach((n) => {
              const i = n === e,
                s = i ? (t === Lt.Ascending ? "asc" : "desc") : Lt.None;
              n.classList.toggle("is-sorted", i && t !== Lt.None),
                n.querySelectorAll(".js-sorting-indicator").forEach((e) => {
                  e.classList.toggle(
                    "d-none",
                    !e.classList.contains("js-sorting-indicator-" + s)
                  );
                }),
                i
                  ? n.setAttribute("aria-sort", t)
      ...
      sort(e) {
        ...
        c.forEach(function (e, n) {
          ...
          d.forEach(([e, t]) => {
            var n;
            const i = c[t];
            null === (n = i.parentElement) || void 0 === n || n.removeChild(i),
              u ? r.insertBefore(i, u) : r.appendChild(i);
          }),
          this.updateSortedColumnStyles(
            i,
            1 === l ? Lt.Ascending : Lt.Descending
          );
      }
    }
    function Kt(e, t) {
    ...
    class _t extends oe {
      ...
      _toggle(e, t = null) {
        ...
        r.defaultPrevented ||
          ((this.returnElement = r.detail.returnElement),
          this.toastTarget.setAttribute("aria-hidden", n ? "false" : "true"),
          n
            ? (this.bindDocumentEvents(),
              this.hideAfterTimeout(),
              "true" !== this.data.get("prevent-focus-capture") &&
                this.focusInsideToast())
            : (this.unbindDocumentEvents(),
              this.focusReturnElement(),
              this.removeToastOnHide(),
              this.clearActiveTimeout()),
          void 0 !== this.toastTarget.ontransitionend
      ...
      hideAfterTimeout() {
        if (
          "true" === this.data.get("prevent-auto-hide") ||
          "0" === this.data.get("hide-after-timeout")
        )
          return;
      ...
      getAllTabbables() {
        return Array.from(
          this.toastTarget.querySelectorAll(
            "[href], input, select, textarea, button, [tabindex]"
          )
        ).filter((e) => e.matches(":not([disabled]):not([tabindex='-1'])"));
      }
      ...
      hideOnOutsideClick(e) {
        var t;
        const n = e.target;
        !(null === (t = this.toastTarget) || void 0 === t
          ? void 0
          : t.contains(n)) &&
          document.body.contains(n) &&
          "false" !== this.data.get("hide-on-outside-click") &&
          this._toggle(!1, e);
      }
      hideOnEscapePress(e) {
        27 === e.which &&
          "true" !== this.toastTarget.getAttribute("aria-hidden") &&
          this._toggle(!1, e);
      }
      getDispatcher(e = null) {
        return e instanceof Event
    ...
    class Wt extends St {
      ...
      show(e = null) {
        const t = re.getControllerForElementAndIdentifier(
          this.element,
          "s-popover"
        );
      ...
      scheduleShow(e = null) {
        window.clearTimeout(this.activeTimeout),
          (this.activeTimeout = window.setTimeout(() => this.show(e), 300));
      }
      scheduleHide(e = null) {
        window.clearTimeout(this.activeTimeout),
          (this.activeTimeout = window.setTimeout(() => super.hide(e), 100));
      }
      clearActiveTimeout() {
        clearTimeout(this.activeTimeout);
      }
      applyTitleAttributes() {
        ...
        if (!i) {
          (i = document.createElement("div")),
            (i.id = n),
            (i.className = "s-popover s-popover__tooltip"),
            i.setAttribute("role", "tooltip");
          const e = this.element.parentNode;
          e
            ? e.insertBefore(i, this.element.nextSibling)
    ...
    function Jt(e, t) {
      t &&
        t.placement &&
        e.setAttribute("data-s-tooltip-placement", t.placement);
    ...
    class Xt extends oe {
      connect() {
        super.connect(),
          (this.boundDragEnter = this.handleUploaderActive.bind(this, !0)),
          (this.boundDragLeave = this.handleUploaderActive.bind(this, !1)),
      ...
      handleInput() {
        if (((this.previewsTarget.innerHTML = ""), !this.inputTarget.files))
          return;
        const e = this.inputTarget.files.length;
        this.getDataURLs(this.inputTarget.files, Xt.FILE_DISPLAY_LIMIT)
          .then((t) => {
            if ((this.handleVisible(!0), t.length > 1)) {
              const n = document.createElement("div");
              n.classList.add("s-uploader--previews-heading"),
                (n.innerText =
                  t.length < e
                    ? `Showing ${t.length} of ${e} files`
                    : `${e} items`),
                this.previewsTarget.appendChild(n),
                this.previewsTarget.classList.add("has-multiple");
            } else this.previewsTarget.classList.remove("has-multiple");
            t.forEach((e) => this.addFilePreview(e)),
              this.handleUploaderActive(!0);
          })
          .catch(() => null);
      }
      reset() {
        (this.inputTarget.value = ""),
          ...
          this.handleVisible(!1);
      }
      handleVisible(e) {
        const { scope: t } = this.targets,
          n = t.findAllElements("[data-s-uploader-hide-on-input]"),
          i = t.findAllElements("[data-s-uploader-show-on-input]"),
          s = t.findAllElements("[data-s-uploader-enable-on-input]");
        e
          ? (n.forEach((e) => {
      ...
      addFilePreview(e) {
        ...
        let n;
        e.type.match("image/*") && e.data
          ? ((n = document.createElement("img")),
            (n.src = e.data.toString()),
            (n.alt = e.name))
          : ((n = document.createElement("div")), (n.innerText = e.name)),
          n.classList.add("s-uploader--preview-thumbnail"),
          t.appendChild(n),
          t.classList.add("s-uploader--preview"),
          t.setAttribute("data-filename", e.name),
          this.previewsTarget.appendChild(t);
      }
      ...
      fileToDataURL(e) {
        const t = new FileReader(),
          { name: n, size: i, type: s } = e;
        return i < Xt.MAX_FILE_SIZE && s.indexOf("image") > -1
          ? new Promise((i, r) => {
              (t.onload = (e) => {
                var t;
                const o =
                  null === (t = null == e ? void 0 : e.target) || void 0 === t
                    ? void 0
                    : t.result;
                o ? i({ data: o, name: n, type: s }) : r();
              }),
                t.readAsDataURL(e);
            })
          : Promise.resolve({ name: n, type: s });
      }
      getDataURLs(e, t) {
        const n = Array.from(e)
          .slice(0, Math.min(t, e.length))
          .map((e) => this.fileToDataURL(e));
        return Promise.all(n);
      }
    }
    return (
      (Xt.targets = ["input", "previews", "uploader"]),
      (Xt.FILE_DISPLAY_LIMIT = 10),
      (Xt.MAX_FILE_SIZE = 10485760),
      re.register("s-banner", ce),
      re.register("s-expandable-control", ve),
      re.register("s-modal", be),
      re.register("s-toast", _t),
      re.register("s-navigation-tablist", Oe),
      re.register("s-popover", Dt),
      re.register("s-table", Vt),
      re.register("s-tooltip", Wt),
      re.register("s-uploader", Xt),
      se.finalize(),
      t
    );
  })()
